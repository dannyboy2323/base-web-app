          ...
          <nav>
            <ul className="flex items-center gap-4 font-mono text-xs leading-5 tracking-tight sm:text-base md:gap-6">
              ...
              <li className="flex before:block sm:gap-4 sm:before:w-[1px] sm:before:bg-gray-200 md:gap-6">
                <Link
                  className="hover:bg-blue focus:bg-blue flex items-center justify-center gap-4 rounded-full bg-black px-4 py-2 text-white transition-colors duration-200 sm:px-6 sm:py-3"
